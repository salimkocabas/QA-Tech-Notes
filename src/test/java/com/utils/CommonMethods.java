...
public class CommonMethods extends PageInitializeAll {
	 ...
	 * This method use TakesScreenshot.class
	 * @param fileName
	 */
	public static void takeScreenshot(String fileName) {
		...
		String scrshotFile = MyConstants.SCREENSHOTS_FILEPATH + fileName + timeStamp() + ".png";
	...
	/**
	 * This method will take a screenshot
	 * This method use Robot.class
	 * @param fileName
	 */
	public static void takeAlertScreenshot(String fileName)    {
	    ...
	    try {
			ImageIO.write(image, "png", new File(scrshotFile));
		} catch (IOException e) {
			e.printStackTrace();
		}
	...
	/**
	 * @author 
	 * This method gives current time as a string like _yyyy_MM_dd_HH_mm_ss
	 * @return current_time
	 */
	...
	public static WebDriverWait getWaitObject() {
		WebDriverWait wait = new WebDriverWait(driver, MyConstants.EXPLICIT_LOAD_TIME);
		return wait;
	}
	...
	/**
	 * This method print Web Page titles
	 * @author bulent.geckin
	 * @param  sec
	 */
	
	public static void waitSec(Integer sec) {
	 ...
	 * This method print Web Page titles
	 * @author bulent.geckin
	 * @return driver.getTitle() as a List
	 */
